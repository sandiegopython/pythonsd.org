...
{% block windowtitle %}San Diego Python - Home{% endblock windowtitle %}


{% block content %}
  <h1>San Diego's Python Community</h1>
  <p>Discussing common Python-related interests to encourage, inspire, and share knowledge</p>

  <div style="margin-top: 30px;">
    <h2>Upcoming events</h2>
    <p>There are a number of events happening almost every week. Our general meetup is usually the last Thursday of the month. For up-to-date information, please check our <a href="http://meetup.com/pythonsd">meetup</a> page.</p>
  </div>
  ...
  <div style="margin-top: 30px;">
    <h2>Your Python project</h2>
    <p>In addition to hosting periodic project days, we have a <a href="https://groups.google.com/group/pythonsd">Google group</a> setup for getting local help on your problem. You can also bring a tough problem to the monthly general meeting as well.</p>
  </div>
  ...
  <div style="margin-top: 30px;">
    ...
    <p>
      ...
      <a href="http://brightscope.com/"><img src="{{ SITEURL }}/images/sponsors/brightscope_logo.png" alt="Brightscope" class="sponsor" /></a>
      <a href="http://qualcomm.com/"><img src="{{ SITEURL }}/images/sponsors/qualcomm_logo.png" alt="Qualcomm" class="sponsor" /></a>
      <a href="https://enthought.com/"><img src="{{ SITEURL }}/images/sponsors/enthought_logo.png" alt="Enthought" class="sponsor" /></a>
      <a href="http://nubedehelado.com/"><img src="{{ SITEURL }}/images/sponsors/nubedehelado_logo.png" alt="Nube de Helado" class="sponsor" /></a>
      <a href="http://www.packtpub.com/mastering-object-oriented-python/book"><img src="{{ SITEURL }}/images/sponsors/mastering-oop-book.jpg" alt="Mastering Object Oriented Programming" class="sponsor" /></a>
      <a href="http://www.jetbrains.com"><img src="{{ SITEURL }}/images/sponsors/jetbrains.png" alt="JetBrains" class="sponsor" /></a>
